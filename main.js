document.addEventListener("DOMContentLoaded", function () {
  ...
  const buttons = {
    ...
    "🎙️ Voiceover AI": "Voiceover AI is generating the audio...",
    "🎞️ Clipper AI": "Clipper AI is assembling the video...",
    "📤 Upload AI": "Upload AI is preparing your content for posting...",
    "⚖️ Legal AI": "Legal AI is checking compliance and copyright...",
